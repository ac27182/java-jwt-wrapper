...
object ClaimsDecoder {
  ...
  implicit def HListDecoder[K, V, Rest <: HList](
      ...
      restDecoder: ClaimsDecoder[Rest]
  ): ClaimsDecoder[FieldType[K, V] :: Rest] =
